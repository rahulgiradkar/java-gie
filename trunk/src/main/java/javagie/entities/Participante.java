...
public class Participante implements Serializable {
    ...
    private Set<Bitacora> vitacoras = new HashSet<Bitacora>();
    
    @OneToMany(mappedBy="participante", cascade= CascadeType.REMOVE)
    private Set<ReservaParticipante> reservas = new HashSet<ReservaParticipante>();
    ...
    public Set<ReservaParticipante> getReservas() {
        return reservas;
    }

    public void setReservas(Set<ReservaParticipante> reservas) {
